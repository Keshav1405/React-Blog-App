...
const Home2 = () => {
    ...
    return (
        <div className='Home2' onClick={openArticle}>
            <img className='castle3' src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRmOvZJ5RiGVWHIRH_QnAOtXylUWW2G-SzyN_FVjemmDCsyi9mEUMNTzbj3FwIjtn3NV38&usqp=CAU" alt="pic" />
            <div className='guide'>
